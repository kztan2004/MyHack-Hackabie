...
import { Building2, CircleDot, GitBranch, Handshake, Network, Rocket, Users } from "lucide-react";
    ...
    <div className="min-h-screen">
      <aside className="fixed inset-y-0 left-0 hidden w-64 border-r border-line bg-white px-4 py-5 lg:block">
        <div className="mb-8 px-2">
          <div className="text-xl font-semibold tracking-normal text-ink">EcosystemGraph AI</div>
          <div className="mt-1 text-sm text-slate-500">Relationship intelligence</div>
        </div>
      ...
      <main className="lg:pl-64">
        <div className="border-b border-line bg-white px-5 py-4 lg:hidden">
          <div className="text-lg font-semibold text-ink">EcosystemGraph AI</div>
        </div>
